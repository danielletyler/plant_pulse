defmodule PlantPulseWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PlantPulseWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PlantPulseWeb.Gettext, "errors", msg, opts)
    end
  end
